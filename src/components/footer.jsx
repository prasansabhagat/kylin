...
export default class footer extends Component {
    render() {
        return (
            <div>
                <Container style={{boxShadow: "0px 0px 0px 0px #9E9E9E", width:'100%'}}>
                <Col sm={6}>
                    <Row>
                        <Col ><img style={{height: 74, width: 99}} src="https://kylin.network/logoWhite.1cfda3b9.svg"></img></Col>
                        <Col ><img style={{height: 74, width: 179}} src="https://kylin.network/foundation.c79c05e6.png"></img></Col>
                    </Row><br></br>
                    <Row>Copyright: 2021 The Kylin Project. All Rights Reserved</Row><br></br>
                    <Row>
                        ...
                        <Col xs><img src="https://kylin.network/link_f.ae02af51.svg"></img></Col>
