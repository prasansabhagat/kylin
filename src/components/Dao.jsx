...
export class Dao extends Component {
    render() {
        return (
            <div style={{paddingBottom: 40, margin:50, }}>
                <Row>
                ...
                <Row style={{padding:20, textAlign:"justify", color:"white",marginLeft:20, backgroundColor:"#c70c59", marginRight:20, borderRadius:'10px', boxShadow:'12px 12px #200002'}}>
